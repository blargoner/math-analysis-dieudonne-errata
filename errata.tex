...
Errata are currently only listed for Chapters I--VIII, not including problems.\footnote{For errata in (and only in) problems, see~\cite{nienhuys}.}
...
\item (71, -2)*: in the proof of~(3.20.15), \(f\after pr_1\) should be~\(f_1\after pr_1\).
\end{itemize}
...
\bibitem{nienhuys} Nienhuys, J.~W. \textit{Errata of Dieudonn\'e's Foundations of Modern Analysis.} Eindhoven University of Technology, 1977.
\end{thebibliography}
\end{document}
